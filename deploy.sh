...
kubectl set image deployment/client-deployment client=ukernel/multi-client:$SHA
kubectl set image deployment/worker-deployment worker=ukernel/multi-worker:$SHA